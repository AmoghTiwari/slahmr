...
python3 -m pip install torch==1.13.0 torchvision==0.14.0 --index-url https://download.pytorch.org/whl/cu117
...
python3 -m pip install torch-scatter -f https://data.pyg.org/whl/torch-1.13.0+cu117.html
# uncomment if pip installation isn't working
# conda install pytorch-scatter -c pyg -y

# install PHALP
python3 -m pip install phalp[all]@git+https://github.com/brjathu/PHALP.git
